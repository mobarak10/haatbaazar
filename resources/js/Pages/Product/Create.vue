                ...
                <div class="card border-0">
                    ...
                    <form @submit.prevent="saveProduct()" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <input type="text" v-model="form.name" required class="form-control" id="name" :placeholder="lang.characters_only">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <select v-model="form.category_id" id="category" required class="form-select">
                        ...
                        <div class="row mb-3">
                            <div class="col-2">
                                <label for="brand" class="form-label required mt-1">{{ lang.brand }}</label>
                            </div>

                            <div class="col-6">
<!--                                    <input type="email" v-model="form.email" class="form-control" id="email" placeholder="Enter email">-->
                                <select v-model="form.brand_id" required id="brand" class="form-select">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <select v-model="form.unit_id" required @change="getUnitLabels" id="unit" class="form-select">
                                    <option :value="null" selected >{{ lang.choose_one }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <input type="number" step="any" required v-model="form.purchase_price" class="form-control" id="purchase_price" :placeholder="lang.enter_purchase_price">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <input type="number" required step="any" v-model="form.sale_price" class="form-control" id="sale_price" :placeholder="lang.enter_sale_price">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <select v-model="form.price_type" required id="price_type" class="form-select">
                                    <option :value="null" selected >{{ lang.choose_one }}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-6">
                                <select v-model="form.type" required id="type" class="form-select">
