                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8">
                                        <input type="text" v-model="form.name" class="form-control" id="name" :placeholder="lang.enter_name">
...
export default {
    ...
    methods:{
        ...
        uploadAvatar(){
            let user_image_uploader = document.getElementById("user_image_uploader");
            ...
            reader.readAsDataURL(user_image_uploader.files[0]);
        },
    },
