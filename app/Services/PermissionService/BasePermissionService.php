...
abstract class BasePermissionService implements PermissionServiceContract
{
     ...
     * @return \Illuminate\Database\Eloquent\Builder|\Illuminate\Database\Eloquent\Model|Permission
     */
    protected function createSinglePermission(string $name, string $description)
    {
